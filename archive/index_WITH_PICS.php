			...
			<div id="about_us">
				...
				<div class="woman">
					...
					<div class="picture_holder">
						<img alt="" src="images/blank.gif" usemap="#she_map">
					</div>
					
					<div class="picture">
						<img alt="" src="images/profile_photos/<?php echo $bride_photo; ?>">
					</div>
				...
				<div class="man">
					...
					<div class="picture_holder">
						<img alt="" src="images/blank.gif" usemap="#he_map">
					</div>
				
					<div class="picture">
						<img alt="" src="images/profile_photos/<?php echo $groom_photo; ?>">
					</div>
				</div>
				<!-- END he -->
